...
Dataset
-------
The dataset is of the ``.json`` format and it is named ``animal-data.json``. This dataset is a modified version from `Austin dataset <https://www.kaggle.com/datasets/aaronschlegel/austin-animal-center-shelter-outcomes-and>`_.
